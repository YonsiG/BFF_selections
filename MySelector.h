...
// Thu Jul 28 03:16:59 2022 by ROOT version 6.12/07
...
public :
   ...
   TTreeReaderValue<UInt_t> nJetPuppi = {fReader, "nJetPuppi"};
   TTreeReaderArray<Float_t> JetPuppi_area = {fReader, "JetPuppi_area"};
   TTreeReaderArray<Float_t> JetPuppi_btagCSVV2 = {fReader, "JetPuppi_btagCSVV2"};
   TTreeReaderArray<Float_t> JetPuppi_btagDeepB = {fReader, "JetPuppi_btagDeepB"};
   TTreeReaderArray<Float_t> JetPuppi_btagDeepCvB = {fReader, "JetPuppi_btagDeepCvB"};
   TTreeReaderArray<Float_t> JetPuppi_btagDeepCvL = {fReader, "JetPuppi_btagDeepCvL"};
   TTreeReaderArray<Float_t> JetPuppi_btagDeepFlavB = {fReader, "JetPuppi_btagDeepFlavB"};
   TTreeReaderArray<Float_t> JetPuppi_btagDeepFlavCvB = {fReader, "JetPuppi_btagDeepFlavCvB"};
   TTreeReaderArray<Float_t> JetPuppi_btagDeepFlavCvL = {fReader, "JetPuppi_btagDeepFlavCvL"};
   TTreeReaderArray<Float_t> JetPuppi_btagDeepFlavG = {fReader, "JetPuppi_btagDeepFlavG"};
   TTreeReaderArray<Float_t> JetPuppi_btagDeepFlavQG = {fReader, "JetPuppi_btagDeepFlavQG"};
   TTreeReaderArray<Float_t> JetPuppi_btagDeepFlavUDS = {fReader, "JetPuppi_btagDeepFlavUDS"};
   TTreeReaderArray<Float_t> JetPuppi_chEmEF = {fReader, "JetPuppi_chEmEF"};
   TTreeReaderArray<Float_t> JetPuppi_chHEF = {fReader, "JetPuppi_chHEF"};
   TTreeReaderArray<Float_t> JetPuppi_eta = {fReader, "JetPuppi_eta"};
   TTreeReaderArray<Float_t> JetPuppi_hfEmEF = {fReader, "JetPuppi_hfEmEF"};
   TTreeReaderArray<Float_t> JetPuppi_hfHEF = {fReader, "JetPuppi_hfHEF"};
   TTreeReaderArray<Float_t> JetPuppi_mass = {fReader, "JetPuppi_mass"};
   TTreeReaderArray<Float_t> JetPuppi_muEF = {fReader, "JetPuppi_muEF"};
   TTreeReaderArray<Float_t> JetPuppi_neEmEF = {fReader, "JetPuppi_neEmEF"};
   TTreeReaderArray<Float_t> JetPuppi_neHEF = {fReader, "JetPuppi_neHEF"};
   TTreeReaderArray<Float_t> JetPuppi_particleNetAK4_B = {fReader, "JetPuppi_particleNetAK4_B"};
   TTreeReaderArray<Float_t> JetPuppi_particleNetAK4_CvsB = {fReader, "JetPuppi_particleNetAK4_CvsB"};
   TTreeReaderArray<Float_t> JetPuppi_particleNetAK4_CvsL = {fReader, "JetPuppi_particleNetAK4_CvsL"};
   TTreeReaderArray<Float_t> JetPuppi_particleNetAK4_QvsG = {fReader, "JetPuppi_particleNetAK4_QvsG"};
   TTreeReaderArray<Float_t> JetPuppi_particleNetAK4_puIdDisc = {fReader, "JetPuppi_particleNetAK4_puIdDisc"};
   TTreeReaderArray<Float_t> JetPuppi_phi = {fReader, "JetPuppi_phi"};
   TTreeReaderArray<Float_t> JetPuppi_pt = {fReader, "JetPuppi_pt"};
   TTreeReaderArray<Float_t> JetPuppi_puId_beta = {fReader, "JetPuppi_puId_beta"};
   TTreeReaderArray<Float_t> JetPuppi_puId_dR2Mean = {fReader, "JetPuppi_puId_dR2Mean"};
   TTreeReaderArray<Float_t> JetPuppi_puId_frac01 = {fReader, "JetPuppi_puId_frac01"};
   TTreeReaderArray<Float_t> JetPuppi_puId_frac02 = {fReader, "JetPuppi_puId_frac02"};
   TTreeReaderArray<Float_t> JetPuppi_puId_frac03 = {fReader, "JetPuppi_puId_frac03"};
   TTreeReaderArray<Float_t> JetPuppi_puId_frac04 = {fReader, "JetPuppi_puId_frac04"};
   TTreeReaderArray<Float_t> JetPuppi_puId_jetR = {fReader, "JetPuppi_puId_jetR"};
   TTreeReaderArray<Float_t> JetPuppi_puId_jetRchg = {fReader, "JetPuppi_puId_jetRchg"};
   TTreeReaderArray<Float_t> JetPuppi_puId_majW = {fReader, "JetPuppi_puId_majW"};
   TTreeReaderArray<Float_t> JetPuppi_puId_minW = {fReader, "JetPuppi_puId_minW"};
   TTreeReaderArray<Float_t> JetPuppi_puId_ptD = {fReader, "JetPuppi_puId_ptD"};
   TTreeReaderArray<Float_t> JetPuppi_puId_pull = {fReader, "JetPuppi_puId_pull"};
   TTreeReaderArray<Float_t> JetPuppi_qgl_axis2 = {fReader, "JetPuppi_qgl_axis2"};
   TTreeReaderArray<Float_t> JetPuppi_qgl_ptD = {fReader, "JetPuppi_qgl_ptD"};
   TTreeReaderArray<Float_t> JetPuppi_rawFactor = {fReader, "JetPuppi_rawFactor"};
   TTreeReaderArray<Int_t> JetPuppi_jetId = {fReader, "JetPuppi_jetId"};
   TTreeReaderArray<Int_t> JetPuppi_nConstChHads = {fReader, "JetPuppi_nConstChHads"};
   TTreeReaderArray<Int_t> JetPuppi_nConstElecs = {fReader, "JetPuppi_nConstElecs"};
   TTreeReaderArray<Int_t> JetPuppi_nConstHFEMs = {fReader, "JetPuppi_nConstHFEMs"};
   TTreeReaderArray<Int_t> JetPuppi_nConstHFHads = {fReader, "JetPuppi_nConstHFHads"};
   TTreeReaderArray<Int_t> JetPuppi_nConstMuons = {fReader, "JetPuppi_nConstMuons"};
   TTreeReaderArray<Int_t> JetPuppi_nConstNeuHads = {fReader, "JetPuppi_nConstNeuHads"};
   TTreeReaderArray<Int_t> JetPuppi_nConstPhotons = {fReader, "JetPuppi_nConstPhotons"};
   TTreeReaderArray<Int_t> JetPuppi_nElectrons = {fReader, "JetPuppi_nElectrons"};
   TTreeReaderArray<Int_t> JetPuppi_nMuons = {fReader, "JetPuppi_nMuons"};
   TTreeReaderArray<Int_t> JetPuppi_puId_nCharged = {fReader, "JetPuppi_puId_nCharged"};
   TTreeReaderArray<Int_t> JetPuppi_qgl_mult = {fReader, "JetPuppi_qgl_mult"};
   TTreeReaderArray<UChar_t> JetPuppi_nConstituents = {fReader, "JetPuppi_nConstituents"};
   ...
   TTreeReaderArray<Int_t> JetPuppi_genJetIdx = {fReader, "JetPuppi_genJetIdx"};
   TTreeReaderArray<Int_t> JetPuppi_hadronFlavour = {fReader, "JetPuppi_hadronFlavour"};
   TTreeReaderArray<Int_t> JetPuppi_partonFlavour = {fReader, "JetPuppi_partonFlavour"};
